...
Процедура ПриСозданииОбъекта( Знач пИмяФайла, Знач пПокрытие, Знач пЛог )
	...
	Для каждого цКлючИЗначение Из покрытыеСтроки Цикл
		...
		пЛог.Предупреждение( "Некорректно рассчитана строка для покрытия. Файл %1, строка %2", пИмяФайла, новСтрока.Номер );
